...
import com.example.buddy.search.providers.ExaApiKeyInterceptor
import com.example.buddy.search.providers.ExaWebSearch
import com.example.buddy.search.providers.LinkUpWebSearch
import com.example.buddy.search.providers.TavilyWebSearch
import okhttp3.ConnectionPool
import okhttp3.OkHttpClient
import java.util.concurrent.TimeUnit

object WebSearchFactory {
    fun create(keyCache: KeyProvider, providerId: String): WebSearch? {
